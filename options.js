...
function fSetCornerImageBehaviourButton() {
    ...
    if (cic.value == "Locked") {
        ...
        document.getElementById("cornerimageno-div").style.display = "block";
    }
...
async function fSetOptions() {
    ...
    document.getElementById("cornerimageno-label").innerHTML = options[4][2];
...
async function fSaveOptions() {
    ...
    let iNumber = encodeURIComponent(document.getElementById("cornerimageno-label").innerHTML);
    ...
    document.getElementById("footeroptionscinumber").innerHTML = decodeURIComponent(iNumber);
